	                                    ...
	                                    <div class="row">
													...
													<div class="input-group">
	                                                    <span class="input-group-btn">
	                                                        <span class="btn btn-primary btn-file">
	                                                            ...
	                                                            <input id="uploadUrl" name="role.url" type="hidden"/>
	                                                        </span>
	                                                    </span>
	                                                </div>
	                                        ...
	                                        <div class="col-md-9 personal-info">
	                                            ...
	                                            <h3>详细信息</h3>
	                                            	...
	                                            	<input name="role.createDate" class="form-control" value='<s:property value="store.dataDetail.createDate"/>' type="hidden">
	                                            	<input name="role.id" class="form-control" value='<s:property value="store.dataDetail.id"/>' type="hidden">
	                                            	<input name="role.state" class="form-control" value='<s:property value="store.dataDetail.state"/>' type="hidden">
	                                            	<input name="role.updateDate" class="form-control" value='<s:property value="store.dataDetail.updateDate"/>' type="hidden">

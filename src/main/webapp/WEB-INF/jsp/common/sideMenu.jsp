 ...
 <!-- SIDE MENU -->
    <div id="skin-select">
        ...
        <div class="dark">
            <form action="#">
                <span>
                    <input type="text" name="search" value="" class="search rounded id_search" placeholder="菜单查询..." autofocus="">
                </span>
            </form>
        </div>
        ...
        <div class="skin-part">
            <div id="tree-wrap">
                <div class="side-bar">
                <s:iterator value="#session['storekey'].menuList">

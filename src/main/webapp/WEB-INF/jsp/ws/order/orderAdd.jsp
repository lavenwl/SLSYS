	                                ...
	                                <div class="body-nest" id="Blank_Page_Content">
	                                    ...
	                                    <div class="row">
													...
													<div class="input-group">
	                                                    <span class="input-group-btn">
	                                                        <span class="btn btn-primary btn-file">
	                                                            ...
	                                                            <input id="uploadUrl" name="order.url" type="hidden"/>
	                                                        </span>
	                                                    </span>
	                                                </div>
	                                            </div>
	                                        ...
	                                        <div class="col-md-9 personal-info">
                                            	...
                                            	<input name="order.createDate" class="form-control" value='<s:property value="store.dataDetail.createDate"/>' type="hidden">
                                            	<input name="order.state" class="form-control" value='1' type="hidden">
                                            	<input name="order.updateDate" class="form-control" value='<s:property value="store.dataDetail.updateDate"/>' type="hidden">
                                                <div class="form-group">
                                                    <label class="col-lg-3 control-label">采购用户:</label>
                                                    <div class="col-lg-8">
                                                        <div class="ui-select">
                                                             <select name="order.userInfoByPurchase.id" id="user_time_zone" class="form-control">
	                                                            <s:iterator value="store.subDataList.get('userInfoByPurchase')">
	                                                            	<s:if test="id == store.dataDetail.userInfoByPurchase.id">
	                                                            		<option value="<s:property value='id'/>" selected="selected"><s:property value='user.id'/>
	                                                            	</s:if>
	                                                            	<s:else>
	                                                            		<option value="<s:property value='id'/>"><s:property value='user.id'/>
	                                                            	</s:else>
	                                                            </s:iterator>
	                                                            </select>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-lg-3 control-label">销售用户:</label>
                                                    <div class="col-lg-8">
                                                        <div class="ui-select">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">合计金额:</label>
                                                    <div class="col-md-8">
                                                        <input name="order.sumMoney" class="form-control" value='<s:property value="store.dataDetail.sumMoney"/>' type="text">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-3 control-label">交易金额:</label>
                                                    <div class="col-lg-8">
                                                        <input name="order.money" class="form-control" value='<s:property value="store.dataDetail.money"/>' type="text">
                                                    </div>
                                                </div>

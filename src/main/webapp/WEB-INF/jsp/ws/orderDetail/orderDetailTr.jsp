...
<tr>
    ...
    <td>
    	...
    	<input name="orderDetail[<s:property value='store.dataDetail.orderDetailCode.substring(10,14).replace("0","")'/>].orderDetailCode" id="orderDetailCode<s:property value="store.dataDetail.orderDetailCode.substring(10,14)"/>" class="form-control" value='<s:property value="store.dataDetail.orderDetailCode"/>' type="hidden">

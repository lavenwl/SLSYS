	                                    ...
	                                    <div class="row">
													...
													<div class="input-group">
	                                                    <span class="input-group-btn">
	                                                        <span class="btn btn-primary btn-file">
	                                                            ...
	                                                            <input id="uploadUrl" name="saleMode.url" type="hidden"/>
	                                                        </span>
	                                                    </span>
	                                                </div>
	                                        ...
	                                        <div class="col-md-9 personal-info">
	                                            ...
	                                            <h3>详细信息</h3>
	                                            	...
	                                            	<input name="saleMode.createDate" class="form-control" value='<s:property value="store.dataDetail.createDate"/>' type="hidden">
	                                            	<input name="saleMode.id" class="form-control" value='<s:property value="store.dataDetail.id"/>' type="hidden">
	                                            	<input name="saleMode.state" class="form-control" value='<s:property value="store.dataDetail.state"/>' type="hidden">
	                                            	<input name="saleMode.updateDate" class="form-control" value='<s:property value="store.dataDetail.updateDate"/>' type="hidden">
	                                                <div class="form-group">
	                                                    <label class="col-md-3 control-label">用户名:</label>
	                                                    <div class="col-md-8">
	                                                        <input name="saleMode.name" class="form-control" value='<s:property value="store.dataDetail.name"/>' type="text">
	                                                    </div>
	                                                </div>

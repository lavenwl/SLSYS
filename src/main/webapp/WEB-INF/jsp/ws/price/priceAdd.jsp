	                                ...
	                                <div class="body-nest" id="Blank_Page_Content">
	                                    ...
	                                    <div class="row">
													...
													<div class="input-group">
	                                                    <span class="input-group-btn">
	                                                        <span class="btn btn-primary btn-file">
	                                                            ...
	                                                            <input id="uploadUrl" name="price.url" type="hidden"/>
	                                                        </span>
	                                                    </span>
	                                                </div>
	                                            </div>
	                                        ...
	                                        <div class="col-md-9 personal-info">
                                            	...
                                            	<input name="price.createDate" class="form-control" value='<s:property value="store.dataDetail.createDate"/>' type="hidden">
                                            	<input name="price.state" class="form-control" value='1' type="hidden">
                                            	<input name="price.updateDate" class="form-control" value='<s:property value="store.dataDetail.updateDate"/>' type="hidden">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="ui-select">
                                                             <select name="price.goods.id" id="user_time_zone" class="form-control">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="ui-select">
                                                             <select name="price.saleMode.id" id="user_time_zone" class="form-control">
                                                ...
                                                <div class="form-group  col-xs-12 col-sm-6">
                                                    <label class="col-md-5 control-label">单位单价（斤）:</label>
                                                    <div class="col-md-7">
                                                        <input name="price.price" class="form-control" value='<s:property value="store.dataDetail.price"/>' type="text">
                                                    </div>
                                                </div>
                                                <div class="form-group  col-xs-12 col-sm-6">
                                                    <label class="col-md-5 control-label">重量:</label>
                                                    <div class="col-md-7">
                                                        <input name="price.weight" class="form-control" value='<s:property value="store.dataDetail.price"/>' type="text">
                                                    </div>
                                                </div>
                                                <div class="form-group  col-xs-12 col-sm-6">
                                                    <label class="col-md-5 control-label">组合单价:</label>
                                                    <div class="col-md-7">
                                                        <input name="price.money" class="form-control" value='<s:property value="store.dataDetail.money"/>' type="text">
                                                    </div>
                                                </div>

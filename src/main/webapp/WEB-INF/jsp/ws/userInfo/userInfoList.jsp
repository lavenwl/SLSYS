			                                    ...
			                                    <tbody>
			                                    	<s:iterator value="store.dataList">
			                                            <tr>
			                                                ...
			                                                <td>
																<s:set var="userId" value="user.id"></s:set>
				                                                <s:property value="store.subDataMap.get('user').get(#userId).name"/>
			                                                </td>
			                                                <td>
																<s:set var="companyId" value="company.id"></s:set>
				                                                <s:property value="store.subDataMap.get('company').get(#companyId).name"/>
			                                                </td>

 ...
 * Package Name:com.sl.global.util 
 * Date:2016年12月16日下午6:23:12 
...
public class StringUtil extends StringUtils {
	...
	public static String lowerFirstChar(String string){
		...
		String firstChar = new String(chars);
		if(chars[0] >= 'A' && chars[0] <= 'Z'){
			string = string.replaceFirst(firstChar, firstChar.toLowerCase());
		}
		return string;
	}
	
	public static void main(String[] args) {
		System.out.println(lowerFirstChar("Base"));
	}
}

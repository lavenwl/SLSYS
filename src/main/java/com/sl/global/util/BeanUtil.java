 ...
 * Function: 反射的Utils函数集合.扩展自Apache Commons BeanUtils. . <br/>  
 * Date: 2016年12月17日 下午7:22:17 <br/> 
 * 
 * @author laven 
 * @version  
 * @since JDK 1.6
...
/**
 * 
 * ClassName: SuperBean <br/> 
 * Function: 临时去错建立的，后续建立正式的bean. <br/> 
 * Reason: TODO ADD REASON(可选). <br/> 
 * Date: 2016年12月17日 下午5:23:59 <br/> 
 * 
 * @author laven 
 * @version  
 * @since JDK 1.6
